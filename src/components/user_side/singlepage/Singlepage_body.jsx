      ...
      <div className="row">
        ...
        <div className="">
            ...
            <div className="row align-items-center mb-4">
              ...
              <div className="col-lg-6 text-center text-sm-end">
                ...
                <button type="button" className="btn btn-primary px-3 ">
                  <i className="text-justify"> Follow</i>
                </button>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <img src="https://mdbootstrap.com/img/new/slides/041.jpg" className="img-fluid shadow-1-strong rounded-5 mb-4 card_pop"
              alt="" />
...
export default Singlepage_body