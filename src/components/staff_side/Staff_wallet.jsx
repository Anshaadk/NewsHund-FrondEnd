      ...
      <ul className="transaction-list">
        {transactions.map((transaction) => (
          ...
          >
            ...
            {transaction.amount > 0 ? 'recived' : 'send'} Recived By News{' '}
            {console.log(transaction)}
            <span className="username">{transaction.sender.username}</span>
          </li>
        ))}
      </ul>
    </div>
